            ...
            <div className="mb-30">
                ...
                <div className="relative min-h-screen flex flex-col items-center justify-center">
                    ...
                    <div className="relative w-full max-w-3xl mb-10 flex justify-start">
                        ...
                        <div className="left-exp-arrow absolute w-0 h-0 border-t-[16px] border-b-[16px] border-r-[20px] border-t-transparent border-b-transparent border-r-white left-90 -translate-x-[10px] top-7"></div>
                    </div>
                    ...
                    <div className="relative w-full max-w-3xl mb-10 flex justify-end">
                        ...
                        <div className="right-exp-arrow absolute w-0 h-0 border-t-[16px] border-b-[16px] border-l-[20px] border-t-transparent border-b-transparent border-l-white left-97 translate-x-[10px] top-7"></div>
                    </div>
