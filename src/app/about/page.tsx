...
export default function About() {
    return (
        <div id="about" className="about-text mt-30 mb-30">
            ...
            <div className="mb-30">
                <div className="mb-20">
                    <p className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl mb-20 text-center">My Experiences</p>
                </div>

                <div className="relative min-h-screen flex flex-col items-center justify-center px-4">
                    {/* vertical line only for sm+ */}
                    ...
                    <div className="relative w-full max-w-3xl mb-10 flex justify-center sm:justify-start">
                        <div className="left-exp bg-white p-4 rounded shadow 
                    w-full max-w-xs sm:w-[300px] md:w-[350px] lg:w-[450px]">
                            <p className="mb-5 text-lg sm:text-xl font-semibold text-black">Game Dev Intern</p>
                    ...
                    {/* 2️⃣ Front-End Dev Intern */}
                    <div className="relative w-full max-w-3xl mb-10 flex justify-center sm:justify-end">
                        <div className="right-exp bg-white p-4 rounded shadow 
                    w-full max-w-xs sm:w-[300px] md:w-[350px] lg:w-[450px]">
                            <p className="mb-5 text-lg sm:text-xl font-semibold text-black">Front-end Dev Intern</p>
                            <p className="mb-1 text-left text-gray-700"><strong>Company:</strong> Seaversity</p>
                            <p className="mb-5 text-left text-gray-700"><strong>Year:</strong> Feb – Mar 2023</p>
                            <p className="text-left text-sm text-gray-700">
                    ...
                    {/* 3️⃣ Outsourced Developer */}
                    <div className="relative w-full max-w-3xl mb-10 flex justify-center sm:justify-start">
                        <div className="left-exp bg-white p-4 rounded shadow 
                    w-full max-w-xs sm:w-[300px] md:w-[350px] lg:w-[450px]">
                            <p className="mb-5 text-lg sm:text-xl font-semibold text-black">Outsourced Developer</p>
                            <p className="mb-1 text-left text-gray-700"><strong>Company:</strong> Seaversity</p>
                            <p className="mb-5 text-left text-gray-700"><strong>Year:</strong> Oct 2023 – Aug 2024</p>
                            <p className="text-left text-sm text-gray-700">
                    ...
                    {/* 4️⃣ Full-Time Front-End Developer */}
                    <div className="relative w-full max-w-3xl mb-10 flex justify-center sm:justify-end">
                        <div className="right-exp bg-white p-4 rounded shadow 
                    w-full max-w-xs sm:w-[300px] md:w-[350px] lg:w-[450px]">
                            <p className="mb-5 text-lg sm:text-xl font-semibold text-black">Full-Time Front-End Developer</p>
                            <p className="mb-1 text-left text-gray-700"><strong>Company:</strong> Seaversity</p>
            ...
            <div className="mb-30 mx-8 sm:mx-5">
                <p className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl mb-20 text-center">I Use These:</p>
            ...
            <div className="stats-text grid grid-cols-1 sm:grid-cols-3 gap-6 mx-28 mb-90">
                {[
